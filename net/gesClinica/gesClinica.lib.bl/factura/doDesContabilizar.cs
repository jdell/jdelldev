...
{
    public class doDesContabilizar : gesClinica.lib.bl._template.gerenteActionBL
    {
        DateTime _fechaDesde;
        DateTime _fechaHasta;
        Empresa _empresa;

        public doDesContabilizar(DateTime fechaDesde, DateTime fechaHasta, Empresa empresa)
        {
        ...
        protected override object accion()
        {
            ...
            List<Factura> facturas = facturaFacade.doGetAllContabilizada(_fechaDesde, _fechaHasta, _empresa);
            ...
            foreach (Factura factura in facturas)
                asientoFacade.doDelete(factura, _empresa);
