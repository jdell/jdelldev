...
namespace gesClinica.app.pc._common
{
    public abstract class cache
    {
        ...
        internal static void InitializeImportacion()
        {
            try
            {
                IMPORTACION = new gesClinica.app.pc._common.secciones.ImportacionSection();
                repsol.util.config.sections.section importacionSetting = repsol.util.config.sections.section.getSectionSetting(gesClinica.lib.common.variables.configpath.GetFullPath(), IMPORTACION.Name);
        ...
        internal static void InitializeFontAgenda()
        {
            try
            {
                FONTAGENDA = new gesClinica.app.pc._common.secciones.FontAgendaSection();
                repsol.util.config.sections.section fontAgendaSetting = repsol.util.config.sections.section.getSectionSetting(gesClinica.lib.common.variables.configpath.GetFullPath(), FONTAGENDA.Name);
