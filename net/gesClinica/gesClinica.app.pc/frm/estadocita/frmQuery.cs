...
namespace gesClinica.app.pc.frm.estadocita
{
    internal class frmQuery:template.frm.consulta.QueryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmQueryEstadoCita";
            this.Text = "Estados Cita";
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.estadocita.ctrl.ctrlQuery();
                ...
                frmEdit vVen = new frmEdit((EstadoCita)ctrl.getRegistroSeleccionado(ref frm), false);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((EstadoCita)ctrl.getRegistroSeleccionado(ref frm), true);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((EstadoCita)ctrl.getRegistroSeleccionado(ref frm));
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        private void frmestadocitaQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.estadocita.ctrl.ctrlQuery();
