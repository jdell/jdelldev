...
{
    class ctrlPrintEmitidas:template.frm.impresion.ctrl.PrintCtrl
    {
        private frmPrintEmitidas _vista;

        public override void imprimir(ref repsol.forms.template.informe.ReportForm frm)
        {
            try
            {
                _vista = (frmPrintEmitidas)frm;
                ...
                if (_vista.cmbEjercicio.SelectedItem != null)
                {
                    ...
                    lib.bl._reports.resumenfacturas.rptResumenFacturas informe = new gesClinica.lib.bl._reports.resumenfacturas.rptResumenFacturas((Ejercicio)_vista.cmbEjercicio.SelectedItem, gesClinica.lib.bl._common.custom.tFACTURA.EMITIDA);
        ...
        public void loadEjercicio(ref frmPrintEmitidas frm)
        {
            try
            {
                _vista = (frmPrintEmitidas)frm;
