...
namespace gesClinica.app.pc.frm.subcuenta
{
    internal class frmQuery:template.frm.consulta.QueryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.panDetail.Size = new System.Drawing.Size(650, 421);
            // 
            // panInfo
            // 
            this.panInfo.Location = new System.Drawing.Point(0, 127);
            this.panInfo.Size = new System.Drawing.Size(650, 25);
            // 
            // panHead
            // 
            this.panHead.Controls.Add(this.txtDescripcion);
            this.panHead.Controls.Add(this.label2);
            this.panHead.Size = new System.Drawing.Size(650, 102);
            // 
            // labNRegistros
            // 
            this.labNRegistros.Size = new System.Drawing.Size(650, 25);
            // 
            // txtDescripcion
            // 
            ...
            this.Name = "frmQuery";
            this.Text = "SubCuentas";
            this.Load += new System.EventHandler(this.frmsubcuentaQry_Load);
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.subcuenta.ctrl.ctrlQuery();
                ...
                frmEdit vVen = new frmEdit((SubCuenta)ctrl.getRegistroSeleccionado(ref frm), false);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((SubCuenta)ctrl.getRegistroSeleccionado(ref frm), true);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((SubCuenta)ctrl.getRegistroSeleccionado(ref frm));
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        private void frmsubcuentaQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.subcuenta.ctrl.ctrlQuery();
