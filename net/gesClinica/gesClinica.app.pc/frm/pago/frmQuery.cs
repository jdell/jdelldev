...
namespace gesClinica.app.pc.frm.pago
{
    internal class frmQuery:template.frm.consulta.QueryForm
    {
        ...
        public frmQuery(Operacion operacion)
        {
            InitializeComponent();
        ...
        protected override void btNuevo_record()
        {
            try
            {
                frmEdit vVen = new frmEdit(this.Operacion);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.pago.ctrl.ctrlQuery();
                ...
                frmEdit vVen = new frmEdit((Pago)ctrl.getRegistroSeleccionado(ref frm), false);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Pago)ctrl.getRegistroSeleccionado(ref frm), true);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Pago)ctrl.getRegistroSeleccionado(ref frm));
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        private void frmpagoQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.pago.ctrl.ctrlQuery();
