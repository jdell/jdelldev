...
namespace gesClinica.app.pc.frm.producto.productodetalle
{
    internal class frmQuery:template.frm.consulta.QueryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmQueryProductoDetalle";
            this.Text = "ProductoDetalles";
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.producto.productodetalle.ctrl.ctrlQuery();
                ...
                frmEdit vVen = new frmEdit((ProductoDetalle)ctrl.getRegistroSeleccionado(ref frm), false);
                vVen.ShowDialog(this);
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((ProductoDetalle)ctrl.getRegistroSeleccionado(ref frm), true);
                vVen.ShowDialog(this);
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((ProductoDetalle)ctrl.getRegistroSeleccionado(ref frm));
                vVen.ShowDialog(this);
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        private void frmproductodetalleQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.producto.productodetalle.ctrl.ctrlQuery();
