...
namespace gesClinica.app.pc.frm.estadoevento
{
    class frmEdit: template.frm.edicion.EditForm
    {
        ...
        public frmEdit()
        {
            ...
            ctrl.ctrlEdit ctrl = new gesClinica.app.pc.frm.estadoevento.ctrl.ctrlEdit();
            repsol.forms.template.BaseForm frm = (repsol.forms.template.BaseForm)this;
            ctrl.inicializarForm(ref frm);
            repsol.forms.template.edicion.EditForm edit = (repsol.forms.template.edicion.EditForm)this;
            ctrl.cargarDatos(ref edit, new EstadoEvento());
        }
        public frmEdit(EstadoEvento objVO)
        {
            InitializeComponent();
        ...
        public frmEdit(EstadoEvento objVO, bool soloconsulta)
            : base(soloconsulta)
        {
            InitializeComponent();
