    ...
    internal class ctrlQuery:template.frm.consulta.ctrl.QueryCtrl
    {
        ...
        protected override System.Data.DataView ListVOToDataView(object listObj)
        {
            try
            {
                ...
                List<TipoOperacion> listaVO = (List<TipoOperacion>)listObj;

                if (listaVO == null)
                    listaVO = new List<TipoOperacion>();

                System.Data.DataTable dt = new System.Data.DataTable(typeof(TipoOperacion).FullName);
                dt.Columns.Add("ID", typeof(int));
                dt.Columns.Add("Descripcion", typeof(string));
                dt.Columns.Add("Facturable", typeof(bool));
                dt.Columns.Add("objVO", typeof(TipoOperacion));

                foreach (TipoOperacion obj in listaVO)
                {
                    System.Data.DataRow dr = dt.NewRow();
                    dr["ID"] = obj.ID;
                    dr["Descripcion"] = obj.Descripcion;
                    dr["Color"] = obj.Facturable;
                    dr["objVO"] = obj;
        ...
        public override object BorrarRegistro(ref repsol.forms.template.consulta.QueryForm frm)
        {
            ...
            {
                _vista = (frmQuery)frm;
                TipoOperacion objVO = (TipoOperacion)this.getRegistroSeleccionado(ref frm);
                lib.bl.tipooperacion.doDelete lnTipoOperacion = new gesClinica.lib.bl.tipooperacion.doDelete(objVO);
        ...
        public override void ConsultaRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            ...
            {
                _vista = (frmQuery)frm;
                lib.bl.tipooperacion.doGetAll lnTipoOperacion = new gesClinica.lib.bl.tipooperacion.doGetAll();
                List<TipoOperacion> ds = lnTipoOperacion.execute();
                if (ds == null) ds = new List<TipoOperacion>();
        ...
        public override void setEstiloGridRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            try
            {
                ...
                _vista.dgConsulta.Columns["Facturable"].AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCells;
            }
            catch (Exception ex)
            {
                throw ex;
