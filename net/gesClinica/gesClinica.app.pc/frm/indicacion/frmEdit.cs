...
namespace gesClinica.app.pc.frm.indicacion
{
    class frmEdit: template.frm.edicion.EditForm
    {
        ...
        public frmEdit()
        {
            ...
            ctrl.ctrlEdit ctrl = new gesClinica.app.pc.frm.indicacion.ctrl.ctrlEdit();
            repsol.forms.template.BaseForm frm = (repsol.forms.template.BaseForm)this;
            ctrl.inicializarForm(ref frm);
            repsol.forms.template.edicion.EditForm edit = (repsol.forms.template.edicion.EditForm)this;
            ctrl.cargarDatos(ref edit, new Indicacion());
        }
        public frmEdit(Indicacion objVO)
        {
            InitializeComponent();
        ...
        public frmEdit(Indicacion objVO, bool soloconsulta)
            : base(soloconsulta)
        {
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmEdit";
            this.Text = "Indicacion";
            this.Load += new System.EventHandler(this.frmindicacionEdit_Load);
        ...
        private void frmindicacionEdit_Load(object sender, EventArgs e)
        {
