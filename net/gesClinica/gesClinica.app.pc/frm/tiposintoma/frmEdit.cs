...
namespace gesClinica.app.pc.frm.tiposintoma
{
    class frmEdit: template.frm.edicion.EditForm
    {
        ...
        public frmEdit()
        {
            ...
            ctrl.ctrlEdit ctrl = new gesClinica.app.pc.frm.tiposintoma.ctrl.ctrlEdit();
            repsol.forms.template.BaseForm frm = (repsol.forms.template.BaseForm)this;
            ctrl.inicializarForm(ref frm);
            repsol.forms.template.edicion.EditForm edit = (repsol.forms.template.edicion.EditForm)this;
            ctrl.cargarDatos(ref edit, new TipoSintoma());
        }
        public frmEdit(TipoSintoma objVO)
        {
            InitializeComponent();
        ...
        public frmEdit(TipoSintoma objVO, bool soloconsulta)
            : base(soloconsulta)
        {
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmEdit";
            this.Text = "Categoria Sintoma";
            this.Load += new System.EventHandler(this.frmtiposintomaEdit_Load);
        ...
        private void frmtiposintomaEdit_Load(object sender, EventArgs e)
        {
