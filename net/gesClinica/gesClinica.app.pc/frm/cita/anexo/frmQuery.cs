...
namespace gesClinica.app.pc.frm.cita.anexo
{
    internal class frmQuery:template.frm.consulta.QueryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmQueryAnexo";
            this.Text = "Anexos";
            this.Load += new System.EventHandler(this.frmanexoQry_Load);
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.cita.anexo.ctrl.ctrlQuery();
                ...
                frmEdit vVen = new frmEdit((Anexo)ctrl.getRegistroSeleccionado(ref frm), false);
                vVen.ShowDialog(this);
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Anexo)ctrl.getRegistroSeleccionado(ref frm), true);
                vVen.ShowDialog(this);
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Anexo)ctrl.getRegistroSeleccionado(ref frm));
                vVen.ShowDialog(this);
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        private void frmanexoQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.cita.anexo.ctrl.ctrlQuery();
