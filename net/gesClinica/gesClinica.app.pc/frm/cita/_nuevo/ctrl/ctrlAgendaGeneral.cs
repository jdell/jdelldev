...
namespace gesClinica.app.pc.frm.cita._nuevo.ctrl
{
    internal class ctrlAgendaGeneral:template.frm.BaseCtrl
    {
        ...
        public void DateChanged(ref frmAgendaGeneral frm)
        {
            try
            {
                ...
                lib.bl.cita.doGetAll lnCita = new gesClinica.lib.bl.cita.doGetAll(new gesClinica.lib.vo.filtro.FiltroCita(null, null, _vista.monthCalendar.Date));
