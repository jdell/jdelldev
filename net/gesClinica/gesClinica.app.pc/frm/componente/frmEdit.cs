...
namespace gesClinica.app.pc.frm.componente
{
    class frmEdit: template.frm.edicion.EditForm
    {
        ...
        public frmEdit()
        {
            ...
            ctrl.ctrlEdit ctrl = new gesClinica.app.pc.frm.componente.ctrl.ctrlEdit();
            repsol.forms.template.BaseForm frm = (repsol.forms.template.BaseForm)this;
            ctrl.inicializarForm(ref frm);
            repsol.forms.template.edicion.EditForm edit = (repsol.forms.template.edicion.EditForm)this;
            ctrl.cargarDatos(ref edit, new Componente());
        }
        public frmEdit(Componente objVO)
        {
            InitializeComponent();
        ...
        public frmEdit(Componente objVO, bool soloconsulta)
            : base(soloconsulta)
        {
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.Load += new System.EventHandler(this.frmcomponenteEdit_Load);
        ...
        private void frmcomponenteEdit_Load(object sender, EventArgs e)
        {
