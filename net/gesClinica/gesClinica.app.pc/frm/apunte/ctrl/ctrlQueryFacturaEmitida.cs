...
{
    internal class ctrlQueryFacturaEmitida:template.frm.consulta.ctrl.QueryCtrl
    {
        frmQueryFacturaEmitida _vista = null;
        ...
        protected override System.Data.DataView ListVOToDataView(object listObj)
        {
            try
            {
                ...
                dt.Columns.Add("NumeroFactura", typeof(Int32));
                ...
                foreach (Apunte obj in listaVO)
                {
                    ...
                    dr["ID"] = obj.ID;
                    dr["Fecha"] = obj.Fecha;
                    dr["NumeroFactura"] = obj.NumeroFactura;
                    dr["Asiento"] = obj.Asiento.Numero;
                    dr["Concepto"] = obj.Concepto;
                    //dr["Debe"] = obj.Debe;
                    dr["Importe"] = obj.Haber;
                    dr["Saldo"] = acumulado;
                    dr["objVO"] = obj;
        ...
        public override object BorrarRegistro(ref repsol.forms.template.consulta.QueryForm frm)
        {
            try
            {
                _vista = (frmQueryFacturaEmitida)frm;
        ...
        public override void ConsultaRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            try
            {
                ...
                {
                    lib.bl.apunte.doGetAllFacturas lnApunte = new gesClinica.lib.bl.apunte.doGetAllFacturas(gesClinica.lib.bl._common.custom.tFACTURA.EMITIDA, (Ejercicio)_vista.cmbEjercicio.SelectedItem);
                    ds = lnApunte.execute();
                }
        ...
        public override void setEstiloGridRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            try
            {
                ...
                _vista.dgConsulta.Columns["NumeroFactura"].HeaderText = "Factura";
        ...
        public void loadEjercicio(ref frmQueryFacturaEmitida frm)
        {
            try
            {
                _vista = (frmQueryFacturaEmitida)frm;
