...
{
    internal class frmQueryFacturaRecibida:template.frm.consulta.QueryForm
    {
        ...
        public frmQueryFacturaRecibida()
            : base(true)
        {
            InitializeComponent();
            this.btImprimir.Visible = true;

            ctrl.ctrlQueryFacturaRecibida ctrl = new gesClinica.app.pc.frm.apunte.ctrl.ctrlQueryFacturaRecibida();
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // frmQueryFacturaRecibida
            // 
            this.ClientSize = new System.Drawing.Size(792, 573);
            this.Name = "frmQueryFacturaRecibida";
        ...
        private void cmbEmpresa_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ctrl.ctrlQueryFacturaRecibida ctrl = new gesClinica.app.pc.frm.apunte.ctrl.ctrlQueryFacturaRecibida();
                frmQueryFacturaRecibida frm = (frmQueryFacturaRecibida)this;
        ...
        protected override void setUserPreferences(repsol.util.setting.userpreferences setting)
        {
            try
            {
                ...
                _setting.settingQueryFacturaRecibida res = (_setting.settingQueryFacturaRecibida)setting;
        ...
        protected override repsol.util.setting.userpreferences getUserPreferences()
        {
            try
            {
                ...
                _setting.settingQueryFacturaRecibida res = new gesClinica.app.pc.frm.apunte._setting.settingQueryFacturaRecibida();
