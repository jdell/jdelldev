...
{
    internal class frmQueryAmortizacion:template.frm.consulta.QueryForm
    {
        ...
        public frmQueryAmortizacion()
            : base(true)
        {
            InitializeComponent();

            ctrl.ctrlQueryAmortizacion ctrl = new gesClinica.app.pc.frm.apunte.ctrl.ctrlQueryAmortizacion();
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // frmQueryAmortizacion
            // 
            this.ClientSize = new System.Drawing.Size(792, 573);
            this.Name = "frmQueryAmortizacion";
        ...
        private void cmbEmpresa_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ctrl.ctrlQueryAmortizacion ctrl = new gesClinica.app.pc.frm.apunte.ctrl.ctrlQueryAmortizacion();
                frmQueryAmortizacion frm = (frmQueryAmortizacion)this;
        ...
        protected override void setUserPreferences(repsol.util.setting.userpreferences setting)
        {
            try
            {
                ...
                _setting.settingQueryAmortizacion res = (_setting.settingQueryAmortizacion)setting;
        ...
        protected override repsol.util.setting.userpreferences getUserPreferences()
        {
            try
            {
                ...
                _setting.settingQueryAmortizacion res = new gesClinica.app.pc.frm.apunte._setting.settingQueryAmortizacion();
