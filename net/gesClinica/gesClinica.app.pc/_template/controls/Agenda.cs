    ...
    class Agenda:System.Windows.Forms.DataGridView
    {
        ...
        void tsbAtenderCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEditDatosClinicos vVen = new gesClinica.app.pc.frm.cita.frmEditDatosClinicos((lib.vo.Cita)this.CitaSeleccionada);
                vVen.ShowDialog();
        ...
        void tsbVerCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEdit vVen = new gesClinica.app.pc.frm.cita.frmEdit((lib.vo.Cita)this.CitaSeleccionada, true);
                vVen.ShowDialog();
                this.RefreshData_II();
            }
            catch (Exception ex)
        ...
        void tsbCopiarCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEdit vVen = new gesClinica.app.pc.frm.cita.frmEdit((lib.vo.Cita)this.CitaSeleccionada);
                vVen.ShowDialog();
        ...
        void tsbBorrarCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (System.Windows.Forms.DialogResult.Yes == System.Windows.Forms.MessageBox.Show(gesClinica.app.pc._common.constantes.messages.WANT_DELETE_RECORD, this.Text, System.Windows.Forms.MessageBoxButtons.YesNo, System.Windows.Forms.MessageBoxIcon.Question))
                {
                    if (borrarCita((lib.vo.Cita)this.CitaSeleccionada))
                        RefreshData_II();
                    else
                        template._common.messages.ShowWarning(gesClinica.app.pc._common.constantes.messages.IMCOMPLETED_OPERATION, this.Text);
                }
                this.RefreshData_II();
            }
            catch (Exception ex)
        ...
        void tsbModificarCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEdit vVen = new gesClinica.app.pc.frm.cita.frmEdit((lib.vo.Cita)this.CitaSeleccionada, false);
                vVen.ShowDialog();
        ...
        void tsbNuevaCita_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.isCeldaValida())
                {
                    ...
                    {
                        gesClinica.app.pc.frm.cita.frmEdit vVen = new gesClinica.app.pc.frm.cita.frmEdit(fecha, sala);
                        vVen.ShowDialog();
                    }
                    else
                    {
                        gesClinica.app.pc.frm.cita.frmEdit vVen = new gesClinica.app.pc.frm.cita.frmEdit(fecha, sala, Paciente);
                        vVen.ShowDialog();
                    }
                    this.RefreshData_II();
                }
        ...
        void tsbMenuVerPaciente_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.paciente.frmEdit vVen = new gesClinica.app.pc.frm.paciente.frmEdit(getFullPaciente(this.CitaSeleccionada), false);
                vVen.ShowDialog();
        ...
        void tsbMenuGenerarRecibo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //gesClinica.app.pc.frm.operacion.frmEdit vVen = new gesClinica.app.pc.frm.operacion.frmEdit(AppointmentToCita(this.SelectedAppointment));
                //vVen.ShowDialog();

                lib.bl.operacion.doGenerate lnOperacionGenerate = new gesClinica.lib.bl.operacion.doGenerate(this.CitaSeleccionada);
        ...
        void tsbProgramarCitas_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.isCeldaValida())
                {
                    ...
                    gesClinica.app.pc.frm.cita.frmEditProgramada vVen = new gesClinica.app.pc.frm.cita.frmEditProgramada(fecha, (lib.vo.Sala)this.Tag);
                    vVen.ShowDialog();
        ...
        void tsbAñadirNotas_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEditNotas vVen = new gesClinica.app.pc.frm.cita.frmEditNotas((lib.vo.Cita)this.CitaSeleccionada);
                vVen.ShowDialog();
        ...
        void tsbModificarEvento_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.evento.frmEdit vVen = new gesClinica.app.pc.frm.evento.frmEdit((lib.vo.Evento)this.EventoSeleccionado, false);
                vVen.ShowDialog();
        ...
        void tsbVerEvento_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.evento.frmEdit vVen = new gesClinica.app.pc.frm.evento.frmEdit((lib.vo.Evento)this.EventoSeleccionado, true);
                vVen.ShowDialog();
        ...
        void tsbNuevoEvento_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.isCeldaValida())
                {
                    ...
                    gesClinica.app.pc.frm.evento.frmEdit vVen = new gesClinica.app.pc.frm.evento.frmEdit(fecha, sala);
                    vVen.ShowDialog();
        ...
        private lib.vo.Paciente getFullPaciente(lib.vo.Cita cita)
        {
            try
            {
                lib.bl.paciente.doGet lnPaciente = new gesClinica.lib.bl.paciente.doGet(cita.Paciente);
        ...
        void tsbPegarPortapapelesCita_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.isCeldaValida())
                {
                    ...
                    {
                        template._common.messages.ShowWarning(gesClinica.app.pc._common.constantes.messages.CLIPBOARD_EMPTY, this.Text);
                        return;
                    }
                    ...
                    gesClinica.app.pc.frm.cita.frmEdit vVen = new gesClinica.app.pc.frm.cita.frmEdit(objVO);
        ...
        void tsbPegarPortapapelesEvento_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.isCeldaValida())
                {
                    ...
                    gesClinica.app.pc.frm.evento.frmEdit vVen = new gesClinica.app.pc.frm.evento.frmEdit(objVO);
                    if (vVen.ShowDialog() == System.Windows.Forms.DialogResult.OK)
        ...
        void itemEstadoEvento_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((evento.EstadoEvento.ID != estado.ID))
                {
                    ...
                    lib.bl.evento.doUpdate lnEvento = new gesClinica.lib.bl.evento.doUpdate(evento);
                    lnEvento.execute();
        ...
        void itemEstadoCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((cita.EstadoCita.ID != estado.ID))
                {
                    ...
                    lib.bl.cita.doUpdate lnCita = new gesClinica.lib.bl.cita.doUpdate(cita);
                    lnCita.execute();
        ...
        public void RefreshData(lib.common.tipos.ParDateTime fecha, lib.vo.Sala sala)
        {
            try
            {
                ...
                //    if (sala != null)
                //    {
                //        gesClinica.lib.bl.evento.doGetAllPorFechaYSala lnEvento = new gesClinica.lib.bl.evento.doGetAllPorFechaYSala(fecha, sala);
                ...
                //        gesClinica.lib.bl.cita.doGetAllPorFechaYSala lnCita = new gesClinica.lib.bl.cita.doGetAllPorFechaYSala(fecha, sala);
        ...
        public void RefreshData(lib.common.tipos.ParDateTime fecha, lib.vo.Paciente paciente)
        {
            try
            {
                ...
                //{
                //    gesClinica.lib.bl.cita.doGetAllPorFechaYPaciente lnCita = new gesClinica.lib.bl.cita.doGetAllPorFechaYPaciente(fecha, paciente);
                //    List<lib.vo.Cita> listCita = lnCita.execute();
                //    foreach (lib.vo.Cita cita in listCita)
                //        if (cita.Presencial) this.Appointments.Add(this.CitaToAppointment(cita));
                //}
        ...
        private void Init()
        {
            try
            {
                ...
                this.InicioHora = lib.bl._common.cache.WorkingHourStart;
                this.InicioMinuto = lib.bl._common.cache.WorkingMinuteStart;
                this.FinHora = lib.bl._common.cache.WorkingHourEnd;
                this.FinMinuto = lib.bl._common.cache.WorkingMinuteEnd;
                    ...
                    if ((row > -1) && (row <= (this.FinHora * 60 + this.FinMinuto - this.InicioHora * 60 - this.InicioMinuto) / this.Salto))
                    {
                        ...
                        if (celdas > 0)
                        {
                            if (row + 1 < this.Rows.Count)
                            {
                                if (celdas == 1)
                                {
                                    this[column, row].Value = cita.Terapia.ToString();
        ...
        public enum tTIPOAGENDA
        {
                GENERAL,
                POR_PACIENTE
        }
        private tTIPOAGENDA getTipoAgenda()
        {
            tTIPOAGENDA res = tTIPOAGENDA.GENERAL;
            if (_paciente != null) res = tTIPOAGENDA.POR_PACIENTE;
            return res;
        }
        ...
        public void RefreshData_II()
        {
            try
            {
                tTIPOAGENDA tipo = getTipoAgenda();
                if (tipo == tTIPOAGENDA.GENERAL)
                {
                    lib.bl.cita.doGetAll lnCita = new gesClinica.lib.bl.cita.doGetAll(new gesClinica.lib.vo.filtro.FiltroCita(null, null, this.Fecha));
                    this.DataSourceCitas = lnCita.execute();

                    lib.bl.evento.doGetAllPorFecha lnEvento = new gesClinica.lib.bl.evento.doGetAllPorFecha(new lib.common.tipos.ParDateTime(this.Fecha));
                    this.DataSourceEventos = lnEvento.execute();
                }
                else if (tipo == tTIPOAGENDA.POR_PACIENTE)
                {
                    lib.common.tipos.ParDateTime fecha = new gesClinica.lib.common.tipos.ParDateTime();
                    fecha.Desde = this.Fecha;
                    fecha.Hasta = this.Fecha.AddDays(1);

                    gesClinica.lib.bl.cita.doGetAllPorFechaYPaciente lnCita = new gesClinica.lib.bl.cita.doGetAllPorFechaYPaciente(fecha, this.Paciente);
                    this.DataSourceCitas = lnCita.execute();

                    this.DataSourceEventos = null;
                }
                this.Load();
            }
            catch (Exception ex)
