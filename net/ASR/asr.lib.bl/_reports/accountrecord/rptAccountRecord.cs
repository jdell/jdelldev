...
{
    public class rptAccountRecord : Informe
    {
        ...
        public rptAccountRecord(DateTime dateFrom, DateTime dateTo, lib.vo.Client client, bool? incoming)
        {
            _dateFrom = dateFrom;
            _dateTo = dateTo;
            _client = client;
        ...
        protected override string getEmbeddedReport()
        {
            try
            {
                ...
                res = "asr.lib.bl._reports.accountrecord.rdlAccountRecord.rdlc";
                return res;
            }
            catch (Exception ex)
            {
