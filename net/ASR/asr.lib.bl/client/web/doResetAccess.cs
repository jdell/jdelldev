...
{
    public class doResetAccess : asr.lib.bl._template.gerenteActionBL
    {
        Client _client;
        public doResetAccess(Client client)
        {
            _client = client;
        }
        ...
        protected override object accion()
        {
            ...
            string postData =
                ...
                "client", "reset", _client.FirstName, _client.LastName, _client.MiddleName, _client.EmailAddress, _client.Inactive, _client.Comments, common.constantes.vacio.IsEmpty(_client.DateOfBirth) ? "null" : _client.DateOfBirth.ToString(), _client.CompanyName, _client.UserName, _client.Password, _client.ID);
