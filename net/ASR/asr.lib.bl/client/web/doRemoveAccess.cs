...
{
    public class doRemoveAccess : asr.lib.bl._template.generalActionBL
    {
        Client _client;
        public doRemoveAccess(Client client)
        {
            _client = client;
        }
        ...
        protected override object accion()
        {
            ...
            _client.UserName = string.Empty;//NO Borramos el password _client.FirstName.ToLower() + _client.ID.ToString();
            ...
            string postData =
                ...
                "client", "download", _client.FirstName, _client.LastName, _client.MiddleName, _client.EmailAddress, _client.Inactive, _client.Comments, common.constantes.vacio.IsEmpty(_client.DateOfBirth) ? "null" : _client.DateOfBirth.ToString(), _client.CompanyName, _client.UserName, _client.Password, _client.ID);
