    ...
    static class Program
    {
        ...
        static void Main()
        {
            try
            {
                //**************** Init ****************
#if LTS
                asr.lib.common.variables.configpath.DIRECTORY = System.IO.Path.GetFullPath(@"..\..\..\asr.lib.bl\bin\LTS");
#else 
#if DEBUG
                ...
                pc.lts.frm._splash.frmSplash vVen = new asr.app.pc.lts.frm._splash.frmSplash();
                ...
                asr.app.pc.lts._common.cache.Initialize();
            ...
            {
                asr.app.pc.lts._common.cache.Dispose();
