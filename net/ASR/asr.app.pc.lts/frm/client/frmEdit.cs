...
namespace asr.app.pc.lts.frm.client
{
    class frmEdit : template.frm.edicion.EditForm, template.interfaces.IPresentation
    {
        ...
        public frmEdit()
        {
            ...
            _frmEmployment = new asr.app.pc.lts.frm.client.employment.frmQuery();
            _frmSkillScore = new asr.app.pc.lts.frm.client.skillscore.frmQuery();

            ctrl.ctrlEdit ctrl = new asr.app.pc.lts.frm.client.ctrl.ctrlEdit();
        ...
        private void InitializeComponent()
        {
            ...
            this.tabPage2.Size = new System.Drawing.Size(539, 503);
        ...
        {/*
            ...
            {*/
                ...
                this.tabControl1.TabPages.Remove(this.tpagePicture);
                this.tabPage2.Text = "Comments";
                //this.tabControl1.TabPages.Remove(this.tpage);
