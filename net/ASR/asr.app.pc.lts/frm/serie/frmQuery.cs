...
namespace asr.app.pc.lts.frm.serie
{
    internal class frmQuery:template.frm.consulta.QueryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmQuery";
            this.Text = "Series";
            this.Load += new System.EventHandler(this.frmserieQry_Load);
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                ctrl.ctrlQuery ctrl = new asr.app.pc.lts.frm.serie.ctrl.ctrlQuery();
                ...
                frmEdit vVen = new frmEdit((Serie)ctrl.getRegistroSeleccionado(ref frm), false);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Serie)ctrl.getRegistroSeleccionado(ref frm), true);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Serie)ctrl.getRegistroSeleccionado(ref frm));
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        private void frmserieQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQuery ctrl = new asr.app.pc.lts.frm.serie.ctrl.ctrlQuery();
