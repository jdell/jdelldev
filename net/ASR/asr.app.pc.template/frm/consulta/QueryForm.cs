...
namespace asr.app.pc.template.frm.consulta
{
    public class QueryForm:repsol.forms.template.consulta.QueryForm
    {
        ...
        public QueryForm():base()
        {
            ...
            this.Activated += new EventHandler(QueryForm_Activated);
        }

        void QueryForm_Activated(object sender, EventArgs e)
        {
            template._common.extend.Translate((repsol.forms.template.consulta.QueryForm)this);
            template._common.extend.Translate((System.Windows.Forms.Control)this.contextMenu2);
        }
        ...
        protected override void btImprimir_record()
        {
            try
            {
                ...
                vVen.RdlCompanyName = lib.bl._common.cache.CompanyName;
