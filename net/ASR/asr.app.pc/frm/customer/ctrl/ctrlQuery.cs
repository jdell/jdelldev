    ...
    internal class ctrlQuery:template.frm.consulta.ctrl.QueryCtrl
    {
        ...
        protected override System.Data.DataView ListVOToDataView(object listObj)
        {
            try
            {
                ...
                List<Customer> listaVO = (List<Customer>)listObj;

                if (listaVO == null)
                    listaVO = new List<Customer>();

                System.Data.DataTable dt = new System.Data.DataTable(typeof(Customer).FullName);
                dt.Columns.Add("ID", typeof(int));
                dt.Columns.Add("Name", typeof(string));
                dt.Columns.Add("Address", typeof(string));
                dt.Columns.Add("Phone", typeof(string));
                dt.Columns.Add("Fax", typeof(string));
                dt.Columns.Add("objVO", typeof(Customer));

                foreach (Customer obj in listaVO)
                {
        ...
        public override object BorrarRegistro(ref repsol.forms.template.consulta.QueryForm frm)
        {
            ...
            {
                _vista = (frmQuery)frm;
                Customer objVO = (Customer)this.getRegistroSeleccionado(ref frm);
                lib.bl.customer.doDelete lnCustomer = new asr.lib.bl.customer.doDelete(objVO);
                lnCustomer.execute();
        ...
        public override void ConsultaRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            ...
            {
                _vista = (frmQuery)frm;
                lib.bl.customer.doGetAll lnCustomer = new asr.lib.bl.customer.doGetAll();
                List<Customer> ds = lnCustomer.execute();
                if (ds == null) ds = new List<Customer>();
        ...
        public override void setEstiloGridRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            try
            {
                ...
                _vista.dgConsulta.Columns["Phone"].AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCells;
                _vista.dgConsulta.Columns["Fax"].AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCells;
                _vista.dgConsulta.Columns["Address"].AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCells;

                _vista.dgConsulta.Columns["Phone"].CellTemplate.Style.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                _vista.dgConsulta.Columns["Fax"].CellTemplate.Style.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
            }
            catch (Exception ex)
            {
                throw ex;
