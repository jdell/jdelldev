    ...
    internal class ctrlEdit: template.frm.edicion.ctrl.EditCtrl
    {
        ...
        public override object getObject(ref repsol.forms.template.edicion.EditForm frm, bool newRecord)
        {
            try
            {
                ...
                objVO.Shift = (lib.vo.tSHIFT)_vista.cmbTurn.SelectedValue;
        ...
        public override void cargarDatos(ref repsol.forms.template.edicion.EditForm frm, object obj)
        {
            try
            {
                ...
                _vista.cmbTurn.SelectedValue = objVO.Shift;
        ...
        public override void guardarDatos(ref repsol.forms.template.edicion.EditForm frm, bool newRecord)
        {
            try
            {
                ...
                Client client = (Client)((asr.app.pc.frm.client.frmEdit)_vista.Owner).InnerVO;
                ...
                ((asr.app.pc.frm.client.frmEdit)_vista.Owner).InnerVO = client;
        ...
        public override void inicializarForm(ref repsol.forms.template.BaseForm frm)
        {
            try
            {
                ...
                _vista.cmbTurn.DataSource = lib.common.funciones.EnumHelper.ToList(typeof(lib.vo.tSHIFT));
                _vista.cmbTurn.DisplayMember = "Value";
                _vista.cmbTurn.ValueMember = "Key";
