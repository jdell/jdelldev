...
namespace asr.app.pc.frm.client.ctrl
{
    internal class ctrlEdit: template.frm.edicion.ctrl.EditCtrl
    {
        ...
        public override object getObject(ref repsol.forms.template.edicion.EditForm frm, bool newRecord)
        {
            try
            {
                ...
                if (_vista.dateDateOfBirth.Checked)
                    objVO.DateOfBirth = _vista.dateDateOfBirth.Value;
                else
                    objVO.DateOfBirth = lib.common.constantes.vacio.FECHA;
        ...
        public override void cargarDatos(ref repsol.forms.template.edicion.EditForm frm, object obj)
        {
            try
            {
                ...
                {
                    _vista.dateDateOfBirth.Value = objVO.DateOfBirth;
                    _vista.dateDateOfBirth.Checked = true;
                }
                else
                    _vista.dateDateOfBirth.Checked = false;


                lib.bl.employment.doGetAllByClient lnEmployment = new asr.lib.bl.employment.doGetAllByClient(objVO);
...
#if CLIENT
                // Tabs
                this._vista.tpageComments.Text = "Comments";
                this._vista.gboxCreditScore.Visible = false;
                this._vista.tabControl1.TabPages.Remove(this._vista.tpageEmploymentHistory);
                this._vista.tabControl1.TabPages.Remove(this._vista.tpageSkillScore);
#endif
            }
            catch (Exception ex)
            {
