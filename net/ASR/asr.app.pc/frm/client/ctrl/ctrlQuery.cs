    ...
    internal class ctrlQuery:template.frm.consulta.ctrl.QueryCtrl
    {
        ...
        protected override System.Data.DataView ListVOToDataView(object listObj)
        {
            try
            {
                ...
                if (_vista.ClientQuery == tCLIENTQUERY.ACCOUNT_RECORD_ONLY)
...
#if CLIENT
                // ContextMenu
                this._vista.accountRecordToolStripMenuItem.Visible = false;
                this._vista.activitiesToolStripMenuItem.Visible = false;
                this._vista.webAccessToolStripMenuItem.Visible = false;
                this._vista.toolStripSeparadorWeb.Visible = false;
                this._vista.toolStripMenuItem1.Visible = false;
#endif
            }
            catch (Exception ex)
            {
