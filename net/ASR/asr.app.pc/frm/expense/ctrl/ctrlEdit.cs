...
namespace asr.app.pc.frm.expense.ctrl
{
    class ctrlEdit: template.frm.edicion.ctrl.EditCtrl
    {
        ...
        public override void cargarDatos(ref repsol.forms.template.edicion.EditForm frm, object obj)
        {
            try
            {
                ...
                lib.bl.invoicedetail.doGetAll lnTest = new asr.lib.bl.invoicedetail.doGetAll();
                
                lib.bl.invoicedetail.doGetAllByInvoice doInvoiceDetail = new asr.lib.bl.invoicedetail.doGetAllByInvoice(objVO);
                objVO.Detail = doInvoiceDetail.execute(); //lnTest.execute();//
        ...
        private void setStyleGrid()
        {
            ...
            _vista.dgDetail.Columns["StateFee"].Visible = false;
            ...
            lib.bl.service.doGetAllExpenses doService = new asr.lib.bl.service.doGetAllExpenses();
