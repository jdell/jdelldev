...
namespace asr.app.pc.lts.frm.service.ctrl
{
    internal class ctrlEdit: template.frm.edicion.ctrl.EditCtrl
    {
        ...
        public override object getObject(ref repsol.forms.template.edicion.EditForm frm, bool newRecord)
        {
            try
            {
                ...
                objVO.Price = Convert.ToSingle(_vista.txtPrice.Text);
                objVO.StateFee = Convert.ToSingle(_vista.txtStateFee.Text);
                objVO.Income = true;
        ...
        public override void cargarDatos(ref repsol.forms.template.edicion.EditForm frm, object obj)
        {
            try
            {
                ...
                _vista.txtPrice.Text = objVO.Price.ToString();
                _vista.txtStateFee.Text = objVO.StateFee.ToString();
            }
            catch (Exception ex)
            {
                throw ex;
