...
namespace gesClinica.app.pc.frm.configuracion
{
    class frmEdit: template.frm.edicion.EditForm
    {
        ...
        public frmEdit()
        {
            ...
            ctrl.ctrlEdit ctrl = new gesClinica.app.pc.frm.configuracion.ctrl.ctrlEdit();
            repsol.forms.template.BaseForm frm = (repsol.forms.template.BaseForm)this;
            ctrl.inicializarForm(ref frm);
            repsol.forms.template.edicion.EditForm edit = (repsol.forms.template.edicion.EditForm)this;
            ctrl.cargarDatos(ref edit, new Configuracion());
        }
        public frmEdit(Configuracion objVO)
        {
            InitializeComponent();
        ...
        public frmEdit(Configuracion objVO, bool soloconsulta)
            : base(soloconsulta)
        {
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.Load += new System.EventHandler(this.frmconfiguracionEdit_Load);
        ...
        private void frmconfiguracionEdit_Load(object sender, EventArgs e)
        {
