...
namespace asr.app.pc.frm.activity
{
    internal class frmQuery:template.frm.consulta.QueryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Load += new System.EventHandler(this.frmactivityQry_Load);
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                ctrl.ctrlQuery ctrl = new asr.app.pc.frm.activity.ctrl.ctrlQuery();
                ...
                frmEdit vVen = new frmEdit((Activity)ctrl.getRegistroSeleccionado(ref frm), false);
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Activity)ctrl.getRegistroSeleccionado(ref frm), true);
                vVen.Client = this.Client;
                vVen.ShowDialog();
                btRefresh_record();
            }
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Activity)ctrl.getRegistroSeleccionado(ref frm));
                vVen.Client = this.Client;
                vVen.ShowDialog();
                btRefresh_record();
            }
        ...
        private void frmactivityQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQuery ctrl = new asr.app.pc.frm.activity.ctrl.ctrlQuery();
