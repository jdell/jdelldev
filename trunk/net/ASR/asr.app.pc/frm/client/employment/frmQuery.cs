...
namespace asr.app.pc.frm.client.employment
{
    internal class frmQuery:template.frm.consulta.QueryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmQuery";
            this.Text = "Employments";
            this.Load += new System.EventHandler(this.frmemploymentQry_Load);
        ...
        protected override void btNuevo_record()
        {
            try
            {
                frmEdit vVen = new frmEdit(new Client());
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                ctrl.ctrlQuery ctrl = new asr.app.pc.frm.client.employment.ctrl.ctrlQuery();
                ...
                frmEdit vVen = new frmEdit((Employment)ctrl.getRegistroSeleccionado(ref frm), false);
                vVen.ShowDialog(this);
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Employment)ctrl.getRegistroSeleccionado(ref frm), true);
                vVen.ShowDialog(this);
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Employment)ctrl.getRegistroSeleccionado(ref frm));
                vVen.ShowDialog(this);
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        private void frmemploymentQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQuery ctrl = new asr.app.pc.frm.client.employment.ctrl.ctrlQuery();
