...
namespace asr.app.pc.frm.client.customer
{
    internal class frmQueryByCustomer:template.frm.consulta.QueryForm
    {
        ...
        protected internal System.Windows.Forms.ComboBox cmbCustomer;

        public frmQueryByCustomer():base(true)
        {
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.panHead.Controls.Add(this.cmbCustomer);
            // 
            // label1
            // 
            ...
            this.cmbCustomer.Location = new System.Drawing.Point(151, 41);
            this.cmbCustomer.Name = "cmbCustomer";
            this.cmbCustomer.Size = new System.Drawing.Size(489, 22);
            this.cmbCustomer.TabIndex = 35;
            this.cmbCustomer.SelectedIndexChanged += new System.EventHandler(this.filtrar_Handler);
            // 
            // superToolTipClient1
            // 
            ...
            this.Name = "frmQueryByCustomer";
            this.Text = "Search Clients by Customers";
            this.Load += new System.EventHandler(this.frmcustomerQry_Load);
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                //ctrl.ctrlQuery ctrl = new asr.app.pc.frm.client.customer.ctrl.ctrlQuery();
                ...
                //frmEdit vVen = new frmEdit((CustomerScore)ctrl.getRegistroSeleccionado(ref frm), false);
                //vVen.ShowDialog(this);
                //btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                //frmEdit vVen = new frmEdit((CustomerScore)ctrl.getRegistroSeleccionado(ref frm), true);
                //vVen.ShowDialog(this);
                //btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                //frmEdit vVen = new frmEdit((CustomerScore)ctrl.getRegistroSeleccionado(ref frm));
                //vVen.ShowDialog(this);
                //btRefresh_record();
            }
            catch (Exception ex)
        ...
        public override void btRefresh_record()
        {
            try
            {
                ...
                ctrl.ctrlQueryByCustomer ctrl = new asr.app.pc.frm.client.customer.ctrl.ctrlQueryByCustomer();
                repsol.forms.template.consulta.QueryForm frm = (repsol.forms.template.consulta.QueryForm)this;
        ...
        private void frmcustomerQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQueryByCustomer ctrl = new asr.app.pc.frm.client.customer.ctrl.ctrlQueryByCustomer();
