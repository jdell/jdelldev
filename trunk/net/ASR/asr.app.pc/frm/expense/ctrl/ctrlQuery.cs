...
namespace asr.app.pc.frm.expense.ctrl
{
    internal class ctrlQuery:template.frm.consulta.ctrl.QueryCtrl
    {
        ...
        public override void ConsultaRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            ...
            {
                _vista = (frmQuery)frm;
                lib.bl.invoice.doGetAllExpenses lnInvoice = new asr.lib.bl.invoice.doGetAllExpenses();
        ...
        public override void setEstiloGridRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            try
            {
                ...
                _vista.dgConsulta.Columns["Comment"].AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
