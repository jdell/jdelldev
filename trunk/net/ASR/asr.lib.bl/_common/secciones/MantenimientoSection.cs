...
{
    class MantenimientoSection : lib.common.tipos.section
    {
        bool _enMantenimiento;

        public bool EnMantenimiento
        {
            get { return _enMantenimiento; }
            set { _enMantenimiento = value; }
        }

        public MantenimientoSection()
        {
            this._name = "Mantenimiento";
            this._enMantenimiento = false;
        }
