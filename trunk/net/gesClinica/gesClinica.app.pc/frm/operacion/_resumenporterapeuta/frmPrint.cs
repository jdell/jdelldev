...
namespace gesClinica.app.pc.frm.operacion._resumenporterapeuta
{
    class frmPrint:template.frm.impresion.PrintForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cmbEjercicio.Location = new System.Drawing.Point(245, 68);
        ...
        private void frmPrint_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ctrl.ctrlPrint ctrl = new gesClinica.app.pc.frm.operacion._resumenporterapeuta.ctrl.ctrlPrint();
