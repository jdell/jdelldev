...
namespace gesClinica.app.pc.frm.operacion._resumenporactividad
{
    class frmPrint:template.frm.impresion.PrintForm
    {
        ...
        internal System.Windows.Forms.ComboBox cmbTerapeuta;
        internal System.Windows.Forms.ComboBox cmbEjercicio;
    
        public frmPrint():base(true)
        {
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.SplitContainer1.Panel1.Controls.Add(this.cmbTerapeuta);
            ...
            // viewer
            // 
            this.viewer.ShowPrintButton = true;
            ...
            this.cmbEmpresa.Location = new System.Drawing.Point(245, 24);
            ...
            this.cmbEjercicio.Location = new System.Drawing.Point(245, 52);
            ...
            this.cmbTerapeuta.Location = new System.Drawing.Point(245, 79);
            this.cmbTerapeuta.Name = "cmbTerapeuta";
            this.cmbTerapeuta.Size = new System.Drawing.Size(376, 21);
            this.cmbTerapeuta.TabIndex = 42;
            // 
            // frmPrint
            // 
        ...
        private void frmPrint_Load(object sender, EventArgs e)
        {
            try
            {
                this.Text += " - Operaciones por Actividad";
                ctrl.ctrlPrint ctrl = new gesClinica.app.pc.frm.operacion._resumenporactividad.ctrl.ctrlPrint();
        ...
        private void cmbEmpresa_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ctrl.ctrlPrint ctrl = new gesClinica.app.pc.frm.operacion._resumenporactividad.ctrl.ctrlPrint();
                frmPrint frm = (frmPrint)this;
                ctrl.loadEjercicio(ref frm);
                ctrl.loadTerapeuta(ref frm);
            }
            catch (Exception ex)
            {
                template._common.messages.ShowError(ex);
