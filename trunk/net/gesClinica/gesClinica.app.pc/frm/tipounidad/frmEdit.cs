...
namespace gesClinica.app.pc.frm.tipounidad
{
    class frmEdit: template.frm.edicion.EditForm
    {
        ...
        public frmEdit()
        {
            ...
            ctrl.ctrlEdit ctrl = new gesClinica.app.pc.frm.tipounidad.ctrl.ctrlEdit();
            repsol.forms.template.BaseForm frm = (repsol.forms.template.BaseForm)this;
            ctrl.inicializarForm(ref frm);
            repsol.forms.template.edicion.EditForm edit = (repsol.forms.template.edicion.EditForm)this;
            ctrl.cargarDatos(ref edit, new TipoUnidad());
        }
        public frmEdit(TipoUnidad objVO)
        {
            InitializeComponent();
        ...
        public frmEdit(TipoUnidad objVO, bool soloconsulta)
            : base(soloconsulta)
        {
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.Load += new System.EventHandler(this.frmtipounidadEdit_Load);
        ...
        private void frmtipounidadEdit_Load(object sender, EventArgs e)
        {
