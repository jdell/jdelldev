...
namespace gesClinica.app.pc.frm.producto
{
    internal class frmQuery:template.frm.consulta.QueryForm
    {
        ...
        internal repsol.forms.controls.TextBoxColor txtLaboratorio;
        ...
        private void InitializeComponent()
        {
            ...
            this.txtLaboratorio = new repsol.forms.controls.TextBoxColor();
            ...
            // panHead
            // 
            this.panHead.Controls.Add(this.txtLaboratorio);
            ...
            this.txtDescripcion.Location = new System.Drawing.Point(170, 30);
            ...
            // txtLaboratorio
            // 
            this.txtLaboratorio.ActivateStyle = true;
            this.txtLaboratorio.BackColor = System.Drawing.Color.White;
            this.txtLaboratorio.ColorEnter = System.Drawing.Color.LightYellow;
            this.txtLaboratorio.ColorLeave = System.Drawing.Color.White;
            this.txtLaboratorio.Location = new System.Drawing.Point(170, 56);
            this.txtLaboratorio.Name = "txtLaboratorio";
            this.txtLaboratorio.Size = new System.Drawing.Size(362, 20);
            this.txtLaboratorio.TabIndex = 1;
            this.txtLaboratorio.TextChanged += new System.EventHandler(this.filtrar_Handler);
            // 
            // label1
            // 
            ...
            this.Name = "frmQuery";
            this.Text = "Productos";
            this.Load += new System.EventHandler(this.frmproductoQry_Load);
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.producto.ctrl.ctrlQuery();
                ...
                frmEdit vVen = new frmEdit((Producto)ctrl.getRegistroSeleccionado(ref frm), false);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Producto)ctrl.getRegistroSeleccionado(ref frm), true);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((Producto)ctrl.getRegistroSeleccionado(ref frm));
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        private void frmproductoQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.producto.ctrl.ctrlQuery();
