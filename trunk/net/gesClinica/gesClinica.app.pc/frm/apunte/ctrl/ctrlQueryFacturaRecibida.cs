...
{
    internal class ctrlQueryFacturaRecibida:template.frm.consulta.ctrl.QueryCtrl
    {
        frmQueryFacturaRecibida _vista = null;
        ...
        public override object BorrarRegistro(ref repsol.forms.template.consulta.QueryForm frm)
        {
            try
            {
                _vista = (frmQueryFacturaRecibida)frm;
        ...
        public override void ConsultaRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            try
            {
                ...
                {
                    lib.bl.apunte.doGetAllFacturas lnApunte = new gesClinica.lib.bl.apunte.doGetAllFacturas(gesClinica.lib.bl._common.custom.tFACTURA.RECIBIDA, (Ejercicio)_vista.cmbEjercicio.SelectedItem);
                    ds = lnApunte.execute();
                }
        ...
        public void loadEjercicio(ref frmQueryFacturaRecibida frm)
        {
            try
            {
                _vista = (frmQueryFacturaRecibida)frm;
