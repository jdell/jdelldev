...
namespace gesClinica.app.pc.frm.estadoevento
{
    internal class frmQuery:template.frm.consulta.QueryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmQueryEstadoEvento";
            this.Text = "Estados Evento";
        ...
        protected override void btModificar_record()
        {
            try
            {
                ...
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.estadoevento.ctrl.ctrlQuery();
                ...
                frmEdit vVen = new frmEdit((EstadoEvento)ctrl.getRegistroSeleccionado(ref frm), false);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btConsulta_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((EstadoEvento)ctrl.getRegistroSeleccionado(ref frm), true);
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        protected override void btDuplicar_record()
        {
            try
            {
                ...
                frmEdit vVen = new frmEdit((EstadoEvento)ctrl.getRegistroSeleccionado(ref frm));
                vVen.ShowDialog();
                btRefresh_record();
            }
            catch (Exception ex)
        ...
        private void frmestadoeventoQry_Load(object sender, EventArgs e)
        {
            try
            {
                ctrl.ctrlQuery ctrl = new gesClinica.app.pc.frm.estadoevento.ctrl.ctrlQuery();
