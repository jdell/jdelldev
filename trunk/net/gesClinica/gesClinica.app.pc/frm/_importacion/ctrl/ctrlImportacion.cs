...
namespace gesClinica.app.pc.frm._importacion.ctrl
{
    class ctrlImportacion:template.frm.BaseCtrl
    {
        ...
        public void eraseALL(ref repsol.forms.template.BaseForm frm, bool primeraParte)
        {
            try
            {
                ...
                lib.bl._importacion.doEraseALL lnImportacion = new gesClinica.lib.bl._importacion.doEraseALL(primeraParte);
                lnImportacion.Processing += new gesClinica.lib.bl._template.actionBL.ProcessingHandler(lnImportacionParte_Processing);
        ...
        public void eraseALLTerceros(ref repsol.forms.template.BaseForm frm)
        {
            try
            {
                ...
                lib.bl._importacion.doEraseALLTerceros lnImportacion = new gesClinica.lib.bl._importacion.doEraseALLTerceros();
                lnImportacion.Processing += new gesClinica.lib.bl._template.actionBL.ProcessingHandler(lnImportacionParte_Processing);
                bool res = lnImportacion.execute();
        ...
        public void importarParte1(ref repsol.forms.template.BaseForm frm)
        {
            try
            {
                ...
                lib.bl._importacion.doImportarParte1 lnImportacionParte = new gesClinica.lib.bl._importacion.doImportarParte1();
                lnImportacionParte.Processing += new gesClinica.lib.bl._template.actionBL.ProcessingHandler(lnImportacionParte_Processing);
        ...
        public void importarParte2(ref repsol.forms.template.BaseForm frm)
        {
            try
            {
                ...
                lib.bl._importacion.doImportarParte2 lnImportacionParte = new gesClinica.lib.bl._importacion.doImportarParte2((lib.vo.Empresa)_vista.cmbRazonSocial.SelectedItem);
                lnImportacionParte.Processing += new gesClinica.lib.bl._template.actionBL.ProcessingHandler(lnImportacionParte_Processing);
                bool res = lnImportacionParte.execute();
                if (res)
                    loadRazonSocial(ref _vista);
        ...
        public void importarParte3(ref repsol.forms.template.BaseForm frm)
        {
            try
            {
                ...
                lib.bl._importacion.doImportarParte3 lnImportacionParte = new gesClinica.lib.bl._importacion.doImportarParte3();
                lnImportacionParte.Processing += new gesClinica.lib.bl._template.actionBL.ProcessingHandler(lnImportacionParte_Processing);
                bool res = lnImportacionParte.execute();
                template._common.messages.ShowWarning("Operación completada", _vista.Text);
            }
        ...
        void lnImportacionParte_Processing(gesClinica.lib.bl._events.ProgressEventArgs e)
        {
            try
            {
