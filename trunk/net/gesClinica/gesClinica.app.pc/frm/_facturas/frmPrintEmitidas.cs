...
{
    class frmPrintEmitidas:template.frm.impresion.PrintForm
    {
        ...
        public frmPrintEmitidas():base(true)
        {
            InitializeComponent();
        }
        ...
        private void frmPrint_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ctrl.ctrlPrintEmitidas ctrl = new gesClinica.app.pc.frm._facturas.ctrl.ctrlPrintEmitidas();
        ...
        private void cmbEmpresa_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ctrl.ctrlPrintEmitidas ctrl = new gesClinica.app.pc.frm._facturas.ctrl.ctrlPrintEmitidas();
                frmPrintEmitidas frm = (frmPrintEmitidas)this;
