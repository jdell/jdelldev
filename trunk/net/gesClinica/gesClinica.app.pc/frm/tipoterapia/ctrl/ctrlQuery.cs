    ...
    internal class ctrlQuery:template.frm.consulta.ctrl.QueryCtrl
    {
        ...
        protected override System.Data.DataView ListVOToDataView(object listObj)
        {
            try
            {
                ...
                List<TipoTerapia> listaVO = (List<TipoTerapia>)listObj;

                if (listaVO == null)
                    listaVO = new List<TipoTerapia>();

                System.Data.DataTable dt = new System.Data.DataTable(typeof(TipoTerapia).FullName);
                dt.Columns.Add("ID", typeof(int));
                dt.Columns.Add("Descripcion", typeof(string));
                dt.Columns.Add("Color", typeof(System.Drawing.Image));
                dt.Columns.Add("Cobrable", typeof(bool));
                dt.Columns.Add("objVO", typeof(TipoTerapia));

                foreach (TipoTerapia obj in listaVO)
                {
                    System.Data.DataRow dr = dt.NewRow();
                    dr["ID"] = obj.ID;
                    dr["Descripcion"] = obj.Descripcion;
                    dr["Color"] = repsol.util.image.CreateImage(System.Drawing.Color.FromName(obj.Color));
                    dr["Cobrable"] = obj.Cobrable;
                    dr["objVO"] = obj;
        ...
        public override object BorrarRegistro(ref repsol.forms.template.consulta.QueryForm frm)
        {
            ...
            {
                _vista = (frmQuery)frm;
                TipoTerapia objVO = (TipoTerapia)this.getRegistroSeleccionado(ref frm);
                lib.bl.tipoterapia.doDelete lnTipoTerapia = new gesClinica.lib.bl.tipoterapia.doDelete(objVO);
        ...
        public override void ConsultaRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            ...
            {
                _vista = (frmQuery)frm;
                lib.bl.tipoterapia.doGetAll lnTipoTerapia = new gesClinica.lib.bl.tipoterapia.doGetAll();
                List<TipoTerapia> ds = lnTipoTerapia.execute();
                if (ds == null) ds = new List<TipoTerapia>();
        ...
        public override void setEstiloGridRegistros(ref repsol.forms.template.consulta.QueryForm frm)
        {
            try
            {
                ...
                _vista.dgConsulta.Columns["Cobrable"].HeaderText = "Cobrable";
