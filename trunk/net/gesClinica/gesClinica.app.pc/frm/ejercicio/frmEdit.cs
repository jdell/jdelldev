...
namespace gesClinica.app.pc.frm.ejercicio
{
    class frmEdit: template.frm.edicion.EditForm
    {
        ...
        public frmEdit()
        {
            ...
            ctrl.ctrlEdit ctrl = new gesClinica.app.pc.frm.ejercicio.ctrl.ctrlEdit();
            repsol.forms.template.BaseForm frm = (repsol.forms.template.BaseForm)this;
            ctrl.inicializarForm(ref frm);
            repsol.forms.template.edicion.EditForm edit = (repsol.forms.template.edicion.EditForm)this;
            ctrl.cargarDatos(ref edit, new Ejercicio());
        }
        public frmEdit(Ejercicio objVO)
        {
            InitializeComponent();
        ...
        public frmEdit(Ejercicio objVO, bool soloconsulta)
            : base(soloconsulta)
        {
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmEdit";
            this.Text = "Ejercicio";
            this.Load += new System.EventHandler(this.frmejercicioEdit_Load);
        ...
        private void frmejercicioEdit_Load(object sender, EventArgs e)
        {
