    ...
    internal class DayView: Calendar.DayView
    {
        ...
        void tsbMenuVerPaciente_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.paciente.frmEdit vVen = new gesClinica.app.pc.frm.paciente.frmEdit(getFullPaciente(this.AppointmentToCita(this.SelectedAppointment)), false);
                vVen.ShowDialog();
        ...
        void tsbMenuGenerarRecibo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lib.bl.operacion.doGenerate lnOperacionGenerate = new gesClinica.lib.bl.operacion.doGenerate(AppointmentToCita(this.SelectedAppointment));
        ...
        void tsbAñadirNotas_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEditNotas vVen = new gesClinica.app.pc.frm.cita.frmEditNotas((lib.vo.Cita)this.SelectedAppointment.Tag);
                vVen.ShowDialog();
                RefreshDayView(this, new EventArgs());
            }
            catch (Exception ex)
        ...
        void tsbModificarEvento_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.evento.frmEdit vVen = new gesClinica.app.pc.frm.evento.frmEdit((lib.vo.Evento)this.SelectedAppointment.Tag, false);
                vVen.ShowDialog();
                RefreshDayView(this, new EventArgs());
            }
            catch (Exception ex)
        ...
        void tsbVerEvento_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.evento.frmEdit vVen = new gesClinica.app.pc.frm.evento.frmEdit((lib.vo.Evento)this.SelectedAppointment.Tag, true);
                vVen.ShowDialog();
                RefreshDayView(this, new EventArgs());
            }
            catch (Exception ex)
        ...
        void tsbNuevoEvento_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.evento.frmEdit vVen = new gesClinica.app.pc.frm.evento.frmEdit(fecha);
                vVen.ShowDialog();
                RefreshDayView(this, new EventArgs());
            }
            catch (Exception ex)
        ...
        void tsbAtenderCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEditDatosClinicos vVen = new gesClinica.app.pc.frm.cita.frmEditDatosClinicos((lib.vo.Cita)this.SelectedAppointment.Tag);
                vVen.ShowDialog();
                RefreshDayView(this, new EventArgs());
            }
            catch (Exception ex)
        ...
        void tsbVerCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEdit vVen = new gesClinica.app.pc.frm.cita.frmEdit((lib.vo.Cita)this.SelectedAppointment.Tag, true);
                vVen.ShowDialog();
                RefreshDayView(this, new EventArgs());
            }
            catch (Exception ex)
        ...
        void tsbCopiarCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEdit vVen = new gesClinica.app.pc.frm.cita.frmEdit((lib.vo.Cita)this.SelectedAppointment.Tag);
                vVen.ShowDialog();
                RefreshDayView(this, new EventArgs());
            }
            catch (Exception ex)
        ...
        private gesClinica.lib.vo.Cita AppointmentToCita(Calendar.Appointment ap)
        {
            try
            {
                gesClinica.lib.vo.Cita res = (gesClinica.lib.vo.Cita)ap.Tag;
                return res;
            }
            catch (Exception ex)
            {
        ...
        private Calendar.Appointment CitaToAppointment(gesClinica.lib.vo.Cita cita)
        {
            try
            {
        ...
        private gesClinica.lib.vo.Evento AppointmentToEvento(Calendar.Appointment ap)
        {
            try
            {
                gesClinica.lib.vo.Evento res = (gesClinica.lib.vo.Evento)ap.Tag;
                return res;
            }
            catch (Exception ex)
            {
        ...
        private Calendar.Appointment EventoToAppointment(gesClinica.lib.vo.Evento evento)
        {
            try
            {
                Calendar.Appointment res = new Calendar.Appointment();
        ...
        void tsbModificarCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEdit vVen = new gesClinica.app.pc.frm.cita.frmEdit((lib.vo.Cita)this.SelectedAppointment.Tag, false);
                vVen.ShowDialog();
                RefreshDayView(this, new EventArgs());
            }
            catch (Exception ex)
        ...
        void tsbNuevaCita_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gesClinica.app.pc.frm.cita.frmEdit vVen = new gesClinica.app.pc.frm.cita.frmEdit(fecha, (lib.vo.Sala)this.Tag);
                vVen.ShowDialog();
                RefreshDayView(this, new EventArgs());
            }
            catch (Exception ex)
