...
{
    public class doCerrarYAbrir : gesClinica.lib.bl._template.administrativoActionBL
    {
        Ejercicio _ejercicio;
        public doCerrarYAbrir(Ejercicio ejercicio)
        {
        ...
        protected override object accion()
        {
            ...
            return ejercicioFacade.doCerrarYAbrir(_ejercicio, new SubCuenta(_common.cache.SUBCUENTAS.SubCuentaPerdidasYGanancias));
        }
    }
}
