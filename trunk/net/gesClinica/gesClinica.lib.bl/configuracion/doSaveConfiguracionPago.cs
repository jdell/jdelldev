...
{
    public class doSaveConfiguracionPago : gesClinica.lib.bl._template.generalActionBL
    {
        Configuracion _configuracion;
        public doSaveConfiguracionPago(Configuracion configuracion)
        {
