...
{
    public class doSaveConfiguracionCita : gesClinica.lib.bl._template.generalActionBL
    {
        Configuracion _configuracion;
        public doSaveConfiguracionCita(Configuracion configuracion)
        {
        ...
        protected override object accion()
        {
            ...
            if (!_configuracion.IsEstadoCita())
