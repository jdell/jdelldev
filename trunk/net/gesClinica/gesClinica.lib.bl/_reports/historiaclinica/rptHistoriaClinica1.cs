...
{
    public class rptHistoriaClinica1: Informe
    {
        private vo.Paciente _paciente = null;
        public rptHistoriaClinica1(lib.vo.Paciente paciente)
        {
            _paciente = paciente;
        }
        ...
        protected override string getEmbeddedReport()
        {
            try
            {
                ...
                res = "gesClinica.lib.bl._reports.quiromasaje.rdlHistoriaClinica1.rdlc";
                return res;
            }
            catch (Exception ex)
            {
