...
namespace gesClinica.lib.dao._common.plain
{
	...
	internal sealed class PlainActionProcessor
	{
		...
		internal static object process(gesClinica.lib.dao._common.DAOFactory factory, NonTransactionalPlainAction action)
		{
		...
		internal static object process(gesClinica.lib.dao._common.DAOFactory factory, TransactionalPlainAction action)
		{
			bool commited = false;
			System.Data.Common.DbConnection connection = null;
