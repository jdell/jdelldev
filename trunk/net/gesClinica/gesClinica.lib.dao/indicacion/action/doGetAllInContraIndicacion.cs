...
{
    class doGetAllInContraIndicacion : gesClinica.lib.dao._common.plain.NonTransactionalPlainAction
    {
        ...
        public object execute(gesClinica.lib.dao._common.DAOFactory factory)
        {
            try
            {
                ...
                return indicacionDAO.doGetAllInContraIndicacion(factory.Command, _producto);
            }
            catch (Exception ex)
            {
                throw ex;
