    ...
    public class rptFacturas: Informe
    {
        ...
        protected override object getDataSource()
        {
            try
            {
                ...
                {
                    lnEmpleado = new asr.lib.bl.empleado.doGet(factura.Empleado);
                    factura.Operacion.Cita.Empleado = lnEmpleado.execute();

                    lib.bl.empresa.doGet lnEmpresa = new asr.lib.bl.empresa.doGet(factura.Operacion.Cita.Empleado.Empresa);
            ...
            try
            {
                ...
                switch (_formatoFactura)
                {
                    case asr.lib.vo.tFORMATOFACTURA.TAO_SALUD:
                        res = "asr.lib.bl._reports.factura.rdlFacturasTAO.rdlc";
                        break;
