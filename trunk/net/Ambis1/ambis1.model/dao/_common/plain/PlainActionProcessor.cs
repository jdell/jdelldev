...
namespace ambis1.model.dao._common.plain
{
	...
	internal sealed class PlainActionProcessor
	{
		...
		internal static object process(ambis1.model.dao._common.DAOFactory factory, NonTransactionalPlainAction action)
		{
		...
		internal static object process(ambis1.model.dao._common.DAOFactory factory, TransactionalPlainAction action)
		{
			bool commited = false;
			System.Data.Common.DbConnection connection = null;
