...
namespace ambis1.model.dao._template
{
        ...
        private class DataBaseConfigSection
        {
            ...
            public static DataBaseConfigSection getDataBaseConfig()
            {
                if (_instance == null)
                {
                    ...
                    repsol.util.config.sections.section dataBaseConfigSetting = repsol.util.config.sections.section.getSectionSetting(model.common.variables.configpath.GetFullPath(), _instance.Name);
